...
import { useNotificationHealth } from '@/lib/api';
...
export default function Notifications() {
  ...
  const unsupported = health.isError && /not found|404|endpoint/i.test(health.error?.message || '');
  const cards = [
