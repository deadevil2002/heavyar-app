...
export type Permission = 'users.read' | 'users.manage' | 'providers.read' | 'providers.manage' | 'drivers.read' | 'drivers.manage' | 'equipment.read' | 'equipment.moderate' | 'requests.read' | 'requests.manage' | 'finance.read' | 'refunds.manage' | 'fees.read' | 'fees.manage' | 'complaints.read' | 'complaints.manage' | 'verification.read' | 'verification.manage' | 'exports.read' | 'staff.manage' | 'security.manage';
const ROLE_PERMISSIONS: Record<string, Permission[]> = {
  owner: ['users.read','users.manage','providers.read','providers.manage','drivers.read','drivers.manage','equipment.read','equipment.moderate','requests.read','requests.manage','finance.read','refunds.manage','fees.read','fees.manage','complaints.read','complaints.manage','verification.read','verification.manage','exports.read','staff.manage','security.manage'],
  super_admin: ['users.read','users.manage','providers.read','providers.manage','drivers.read','drivers.manage','equipment.read','equipment.moderate','requests.read','requests.manage','finance.read','refunds.manage','fees.read','fees.manage','complaints.read','complaints.manage','verification.read','verification.manage','exports.read','staff.manage'],
  ...
  auditor: ['users.read','providers.read','drivers.read','equipment.read','requests.read','finance.read','fees.read','complaints.read','verification.read','exports.read'],
  marketing: [],
};
