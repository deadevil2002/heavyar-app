...
const messages = {
  ar: {
    ...
    DUPLICATE_COMPLETE_EMAIL: 'هذا البريد الإلكتروني مستخدم بالفعل. يمكنك تسجيل الدخول إلى حسابك.',
  ...
  en: {
    ...
    DUPLICATE_COMPLETE_EMAIL: 'This email is already in use. You can sign in to your account.',
